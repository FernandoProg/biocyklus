    ...
    <body>
        <nav class="navbar bg-success p-3">
            <div class="container-fluid">
                <a class="navbar-brand"><img src="{{ asset('storage/images/static/logo.jpeg') }}" class="img-fluid" alt="description of myimage" width="200" height="200"></a>
                <div class="d-flex">
                    <div class="row">
                        <div class="col-lg-12">
                            <a class="btn btn-success mx-1 fs-5" href="#" role="button">Sobre Nosotros</a>
                            <a class="btn btn-success mx-1 fs-5" href="#" role="button">Contactos</a>
                            <a class="btn btn-success mx-1 fs-5" href="#" role="button">Términos y condiciones</a>
                        </div>
                    </div>
                </div>
                <form class="d-flex" role="search">
                    @auth
                        <a
                            href="{{ url('/dashboard') }}"
                            class="btn btn-success mx-1 fs-5" role="button">
                            Dashboard
                        </a>
                    @else
                        <a
        ...
        <footer class="bg-success-subtle text-center">
            <!-- Grid container -->
            <div class="container p-4">
            <!-- Section: Social media -->
            <section class="mb-4">
                <!-- Facebook -->
                <a data-mdb-ripple-init class="btn btn-outline btn-floating m-1" href="https://www.facebook.com/francisca.devorguez" role="button">
                ...
                <!-- Twitter -->
                <a data-mdb-ripple-init class="btn btn-outline btn-floating m-1" href="https://x.com/home?lang=es" role="button">
                ...
                <!-- Instagram -->
                <a data-mdb-ripple-init class="btn btn-outline btn-floating m-1" href="https://www.instagram.com/francisca.andrea_g/" role="button">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                ...
                <!-- Linkedin -->
                <a data-mdb-ripple-init class="btn btn-outline btn-floating m-1" href="https://www.linkedin.com/in/francisca-andrea-gonzalez-vejar-90a061278/" role="button">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                ...
                <!-- Github -->
                <a data-mdb-ripple-init class="btn btn-outline btn-floating m-1" href="https://github.com/FernandoProg" role="button">
            ...
            © 2024 Copyright:
            <a class="text-reset fw-bold" href="https://www.linkedin.com/in/fernando-cabezas-b22061279/">Fernando Cabezas</a>
            </div>
            <!-- Copyright -->
        </footer>
    </body>
