            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @if(auth()->user()->restaurantes)
                        <p><strong>Nombre:</strong> {{ auth()->user()->restaurantes->nombre }}</p>
                        <p><strong>Dirección:</strong> {{ $direccionRestaurante ? $direccionRestaurante : 'Ubicación no disponible' }}</p>
                        <p><strong>Teléfono:</strong> {{ auth()->user()->restaurantes->telefono }}</p>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @if(auth()->user()->organizacion)
                        <p><strong>Nombre:</strong> {{ auth()->user()->organizacion->nombre }}</p>
                        <p><strong>Descripción:</strong> {{ auth()->user()->organizacion->descripcion }}</p>
                        <p><strong>Contacto:</strong> {{ auth()->user()->organizacion->contacto }}</p>
                    @else
